...
def files_sorter(path: Path):  # Ось тут маю проблему(((
    ...
    print(f'\n ______________________________________________________Files found in folders:__________________________________________________________________ \n')
...
def files_ext(path: Path):
    ...
    print(f'\n____________________________________________________Files extensions found in files:______________________________________________________________\n')
